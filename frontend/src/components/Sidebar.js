...
export default function Sidebar() {
  ...
  const allNavItems = [
    ...
    { 
      name: 'İzin Talepleri', path: '/admin/doctor-leaves', color: '#0ea5e9', roles: ['ADMIN'],
    ...
    {
      name: 'Poliklinik Sırası', path: '/doctor/queue', color: '#8b5cf6', roles: ['DOCTOR'],
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> 
    },
    {
      name: 'İzin Taleplerim', path: '/doctor/leaves', color: '#14b8a6', roles: ['DOCTOR'],
    ...
    {
      name: 'Tıbbi Kayıtlarım', path: '/patient-records', color: '#10b981', roles: ['PATIENT'],
